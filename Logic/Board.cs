...
namespace Logic
{
    public class Board
    {
        ...
        {
            //Lays out the board for both players in each grid
            //Top section lays out the board from top to bottom for the Black side of the board
            ...
            //Lower section lays out the bottom of the board for the White side of the board from Bottom to top
        ...
        {
            return PiecePositionFor(colour).First(pos => this[pos].Type == type);
        }
